                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="tdNewsAdminCenter">
                                        ...
                                        if (isset($_GET['p']) && $_GET['p'] == $_SESSION['uid']) {
                                            echo ' disabled="disabled"';
                                        }
                                        ?>>
                                            <option value="5" <?php
                                            if ($user['role'] == 5 || !$_GET['p']) {
                                                echo 'selected="selected"';
                                            }
                                            ?>
                                            ><?php echo ADMINISTRATORS;?></option>
                                            <option value="4" <?php
                                            if ($user['role'] == 4) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo SUPEREDITORS; ?></option>
                                            <option value="3" <?php
                                            if ($user['role'] == 3) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo PUBLISHERS;?></option>
                                            <option value="2" <?php
                                            if ($user['role'] == 2) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo CONTRIBUTORS;?></option>
                                        </select>
                                    </td>
