...
if (isset($_POST['save'])) {
    ...
    $showdate = (int) isset($_POST['news_showdate']);

    $textlink = (int) isset($_POST['news_textlink']);
                    ...
                    <div id="rightContent">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdRestSetupCenter">
                                            <select name="no_image1">
                                                ...
                                                ?>><?php echo SHOWASEMPTYIMG;?></option>
                                                <option value="1" <?php
                                                if ($site['no_image1'] == 1) {
                                                    echo 'selected="selected"';
                                                }
                        ...
                        <div id="webSiteRight">    
                            ...
                            <div id="newsWebSettings">
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td class="tdNewsSetupLeft"><input type="checkbox" class="checkbox" name="news_readmore"<?php
                                    ...
                                    <tr>
                                        <td class="tdNewsSetupLeft"><input type="checkbox" class="checkbox" name="news_showdate"<?php
                                    ...
                                    <tr>
                                        <td class="tdNewsSetupLeft"><input type="checkbox" class="checkbox" name="news_textlink"<?php
                                        if ($site['news_textlink'] == 1) {
                                            echo ' checked="checked"';
                                        }
                                        ?> /></td>
