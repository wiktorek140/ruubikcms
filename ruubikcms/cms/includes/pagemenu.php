        ...
        <div id="rootMenu">
            ...
            foreach ($dbh->query($sql) as $row) {
              echo '  <div class="arrowdiv1"><a href="index.php' .
                ...
                '&amp;moveup=1&amp;token=' .
                $token .
                '"><img src="images/arrow1.gif" class="imgover" alt="arrow" /></a></div>
                            <div class="rootPage"><a href="index.php' .
                '?p=' .
                $row['pageurl'] .
                '"' .
                ($row['pageurl'] == root_page($p) ? ' class="selected"' : '') .
                '>' .
                ec($row['name']) .
                '</a></div>
                            <div class="subMenu1"' .
            ...
            // loop free pages
            echo '  <div class="rootPageFree"><a href="index.php' .
              '?p=---notinmenu---">' .
              FREEPAGES .
              '</a></div>
                        <div class="subMenu1"' .
              (($p == '---notinmenu---' or root_page($p) == '---notinmenu---') ? ' id="open"' : '') .
              '>';
