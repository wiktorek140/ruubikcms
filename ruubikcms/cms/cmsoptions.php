...
if (isset($_POST['save']) and !(isset($_POST['restore']) || isset($_POST['backup']) || isset($_POST['undo']))) {
    ...
    $stmt = $dbh->prepare(
        'INSERT OR REPLACE INTO options (id, cmslang, resize_width, resize_height, logout_time, pagination_rows, use_help) VALUES (1, ?, ?, ?, ?, ?, ?)',
    );
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdCMSSetupCenter">
                                            <select name="logout_time">
                                                ...
                                                if ($cmsoptions['logout_time'] == 900) {
                                                    echo 'selected="selected"';
                                                }
                                                ?>
                               >15 min</option>
                                                <option value="1800" <?php
                                                if ($cmsoptions['logout_time'] == 1800) {
                                                    echo 'selected="selected"';
                                                }
                                                ?>
                   >30 min</option>
                                                <option value="2700" <?php
                                                if ($cmsoptions['logout_time'] == 2700) {
                                                    echo 'selected="selected"';
                                                }
                                                ?>
                                                >45 min</option>
                                                <option value="3600" <?php
                                                if ($cmsoptions['logout_time'] == 3600) {
                                                    echo 'selected="selected"';
                                                }
                                                ?>
                                                >60 min</option>
                                                <option value="5400" <?php
                                                if ($cmsoptions['logout_time'] == 5400) {
                                                    echo 'selected="selected"';
                                                }
                                                ?>
                                                >90 min</option>
                                                <option value="7200" <?php
                                                if ($cmsoptions['logout_time'] == 7200) {
                                                    echo 'selected="selected"';
                                                }
                                                ?>
                                                >2 h</option>
                                                <option value="14400" <?php
                                                if ($cmsoptions['logout_time'] == 14400) {
                                                    echo 'selected="selected"';
                                                }
                                                ?>
                                                >4 h</option>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdCMSSetupCenter"><input type="text" name="pagination_rows" value="<?php
                                        if (isset($cmsoptions['pagination_rows'])) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdCMSSetupCenter">
                                            <select name="use_help">
                                                <option value="0" <?php echo $cmsoptions['use_help'] == 0 ? 'selected="selected"' : ''; ?>
                                                ><?php echo DISABLED; ?></option>
                                                <option value="1" <?php
                                                if ($cmsoptions['use_help'] == 1) {
                                                    echo 'selected="selected"';
                                                }
                                                ?>
