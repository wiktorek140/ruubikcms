                            ...
                            <div id="settingsCMS">
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdCMSSetupCenter">
                                            <select name="logout_time">
                                                <option value="900" <?php if ($cmsoptions['logout_time'] == 900) {
                                                    echo 'selected="selected"';
                                                                    }?>>15 min</option>
                                                <option value="1800" <?php if ($cmsoptions['logout_time'] == 1800) {
                                                    echo 'selected="selected"';
                                                                     }?>>30 min</option>
                                                <option value="2700" <?php if ($cmsoptions['logout_time'] == 2700) {
                                                    echo 'selected="selected"';
                                                                     }?>>45 min</option>
                                                <option value="3600" <?php if ($cmsoptions['logout_time'] == 3600) {
                                                    echo 'selected="selected"';
                                                                     }?>>60 min</option>
                                                <option value="5400" <?php if ($cmsoptions['logout_time'] == 5400) {
                                                    echo 'selected="selected"';
                                                                     }?>>90 min</option>
                                                <option value="7200" <?php if ($cmsoptions['logout_time'] == 7200) {
                                                    echo 'selected="selected"';
                                                                     }?>>2 h</option>
                                                <option value="14400" <?php if ($cmsoptions['logout_time'] == 14400) {
                                                    echo 'selected="selected"';
                                                                      }?>>4 h</option>
                                            </select>                                    
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdCMSSetupCenter"><input type="text" name="resize_width" value="<?php if (isset($cmsoptions['resize_width'])) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdCMSSetupCenter"><input type="text" name="resize_height" value="<?php if (isset($cmsoptions['resize_height'])) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdCMSSetupCenter"><input type="text" name="pagination_rows" value="<?php if (isset($cmsoptions['pagination_rows'])) {
                                            echo $cmsoptions['pagination_rows'];
                                                                                                                      }?>" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdCMSSetupCenter">
                                            <select name="use_help">
                                                <option value="0" <?php if ($cmsoptions['use_help'] == 0) {
                                                    echo 'selected="selected"';
                                                                  }?>><?php echo DISABLED;?></option>
                                                <option value="1" <?php if ($cmsoptions['use_help'] == 1) {
                                                    echo 'selected="selected"';
